...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "তুমি কি ম্যাজিক জানো? কারণ তোমার presence আমাকে hypnotize করে দেয়! 🥵",
          "তোমার উপস্থিতি আমার সিস্টেমে নতুন আপডেট আনছে! 😉",
          "আমি কিন্তু রেগে আছি, এত দেরি করে কেন আসলে?😒",
          
          "কি গো শুনা এত ডাকো কেনো তোমার বুকের মধ্যেই তো আছি🥰",
          "হুম জান তোমার অইখানে উম্মমাহ😷😘",
          "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি🥰",
          "boss বশিরের সাথে sex করছিলাম ডাকলি কেন😩",
          "বলো জানু🥰",
          "বার বার ডাকস কেন 😒"
        ];
